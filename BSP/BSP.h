...
#define LSM303DLHC_I2C_TX_DMA_STREAM        LL_DMA_STREAM_0
#define LSM303DLHC_I2C_TX_DMA_STREAM_IRQ    DMA1_Stream0_IRQn
#define LSM303DLHC_I2C_TX_DMA_CHANNEL       LL_DMA_CHANNEL_0
#define LSM303DLHC_I2C_RX_DMA_STREAM        LL_DMA_STREAM_1
#define LSM303DLHC_I2C_RX_DMA_STREAM_IRQ    DMA1_Stream1_IRQn
